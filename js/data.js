...
const itineraryData = {
    ...
    2: {
        ...
        locations: [
            ...
            },
            {
                time: "11:30",
                name: "PARCO 2 購物時間",
                desc: "BAO BAO ISSEY MIYAKE、Aesop 等精品店",
                category: "shopping",
                mealType: "parco2",
                tags: ["🛍️ 購物", "👜 包包"],
    ...
    3: {
        ...
        hotel: {
            name: "Daiwa Roynet Hotel Sendai Nishiguchi PREMIER",
            location: "仙台西口",
            features: ["🛁 頂樓天然溫泉", "📍 仙台站西口直達"]
        },
        locations: [
            {
                time: "08:30",
                name: "Date Cafe O'rder（站內）",
                desc: "出發前必吃！推薦茶泡飯套餐或飯糰",
                category: "restaurant",
                mealType: "breakfast",
                tags: ["🍚 茶泡飯", "🍙 飯糰"],
                coords: [38.2609, 140.8824]
    ...
    4: {
        ...
        locations: [
            ...
            },
            {
                time: "09:30",
                name: "仙台海洋森林水族館",
                desc: "超大型水槽與東北特有魚種，不可錯過精彩的海豚與海獅表演！",
                category: "attraction",
                mealType: null,
                tags: ["🐬 水族館", "🐟 海洋生物"],
            ...
            },
            {
                ...
                desc: "東北最大 Outlet，BEAMS、United Arrows、Nike 等 120+ 品牌大採購",
                category: "shopping",
                mealType: null,
                tags: ["🛍️ Outlet", "👟 運動品牌"],
                coords: [38.3042, 141.0386]
    ...
    5: {
        ...
        hotel: {
            name: "Daiwa Roynet Hotel Sendai Ichibancho PREMIER",
            location: "仙台一番町",
            features: ["📍 一番町商圈核心", "🛁 大浴場"]
        },
        locations: [
            {
                time: "09:00",
                name: "仙台歷史景點巡禮",
                desc: "瑞鳳殿、仙台城跡、大崎八幡宮等景點可選",
                category: "attraction",
                mealType: "sightseeing",
                tags: ["⛩️ 歷史", "🏯 伊達政宗"],
...
const supermarkets = [
    {
        ...
        desc: "Yodobashi 內的平價超市，肉品生鮮特別便宜",
        category: "market",
        tags: ["🛒 超市", "🥩 肉品"],
...
const restaurantOptions = {
    ...
    "day3_sightseeing": [
        {
            ...
            tags: ["⛩️ 寺廟", "📸 打卡"],
            hours: "24小時開放",
            coords: [38.3690, 141.0625]
        },
        {
            name: "瑞巖寺",
            desc: "伊達政宗菩提寺，國寶級歷史建築",
            tags: ["⛩️ 國寶", "🏯 歷史"],
            hours: "08:00-17:00",
            coords: [38.3685, 141.0615]
        },
        {
            name: "松島三景（觀瀾亭）",
            desc: "伊達家茶室，可品茶並欣賞海灣絕景",
            tags: ["🍵 茶室", "🌊 海景"],
            hours: "08:30-17:00",
            coords: [38.3692, 141.0620]
        }
    ],
    "day3_lunch": [
        {
            name: "松島魚市場",
            desc: "必吃牡蠣漢堡！市場直送的新鮮海產",
            tags: ["🦪 牡蠣漢堡", "⭐ 必吃"],
            hours: "10:00-17:00",
    ...
    "day6_sightseeing": [
        ...
        },
        {
            ...
            tags: ["⛩️ 神社", "🌾 農業"],
            hours: "05:00-20:00",
            coords: [38.3150, 141.0215]
        }
    ],
    "day6_lunch": [
        {
            name: "廻鮮寿司 塩釜港",
            desc: "鹽竈排隊第一名店，迴轉壽司的極品",
            tags: ["🍣 壽司", "⭐ 必吃"],
            hours: "11:00-21:00",
            coords: [38.3103, 141.0242]
        },
